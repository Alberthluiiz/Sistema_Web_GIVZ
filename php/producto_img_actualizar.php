...
$check_producto = $check_producto->query("SELECT * FROM givz_tproducto WHERE tproducto_id='$product_id'");
...
/* Nombre de la imagen */
$img_nombre = renombrar_fotos($datos['tproducto_nombre']);
...
if (is_file($img_dir . $datos['tproducto_foto']) && $datos['tproducto_foto'] != $foto) {

    chmod($img_dir . $datos['tproducto_foto'], 0777);
    unlink($img_dir . $datos['tproducto_foto']);
}


/*== Actualizando datos ==*/
$actualizar_producto = conexion();
$actualizar_producto = $actualizar_producto->prepare("UPDATE givz_tproducto SET tproducto_foto=:foto WHERE tproducto_id=:id");
