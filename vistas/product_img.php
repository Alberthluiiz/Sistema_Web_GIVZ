...
<div class="container pb-6 pt-6">
	...
	$check_producto = $check_producto->query("SELECT * FROM givz_tproducto WHERE tproducto_id='$id'");
	...
	?>
		...
		<div class="columns">
			<div class="column is-two-fifths">
				<?php if (is_file("./img/producto/" . $datos['tproducto_foto'])) { ?>
					<figure class="image mb-6">
						<img src="./img/producto/<?php echo $datos['tproducto_foto']; ?>">
					</figure>
					<form class="FormularioAjax" action="./php/producto_img_eliminar.php" method="POST" autocomplete="off">

						<input type="hidden" name="img_del_id" value="<?php echo $datos['tproducto_id']; ?>">
			...
			<div class="column">
				<form class="mb-6 has-text-centered FormularioAjax" action="./php/producto_img_actualizar.php" method="POST" enctype="multipart/form-data" autocomplete="off">
					...
					<h4 class="title is-4 mb-6"><?php echo $datos['tproducto_nombre']; ?></h4>

					<label>Foto o imagen del producto</label><br>

					<input type="hidden" name="img_up_id" value="<?php echo $datos['tproducto_id']; ?>">
